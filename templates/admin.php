...
<body class="upsent_plugin_manager">
    ...
    <section>
        ...
        $he_tec = isset($_POST['he-tec']) ? $_POST['he-tec'] : '';
        $budget_state = isset($_POST['status_orcamento']) ? $_POST['status_orcamento'] : '';
        $rat=isset($_POST['ordem_servico'])?$_POST['ordem_servico']:'';
